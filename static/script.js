...
*/
 function greetingFunc() {
    ...
    if (h>=5 && h<12) {
        E.innerHTML=" Good morning, I am Martin Jimenez";
    } else if (h>=12 && h<18) {
        E.innerHTML+=" Good afternoon, I am Martin Jimenez";
    } else if (h>=18 && h<20) {
        E.innerHTML=" Good evening, I am Martin Jimenez";
    } else  {
        E.innerHTML="Good night, I am Martin Jimenez";
    } }
...
async function initMap() {
 // The location of CMU
 const position = { lat: 40.44692, lng:-79.94269};
